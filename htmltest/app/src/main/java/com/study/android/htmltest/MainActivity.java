...
public class MainActivity extends AppCompatActivity {
    ...
    public class Description extends AsyncTask<String, Void, ItemObject[]> {
        ...
        protected ItemObject[] doInBackground(String... params) {
            try {
                Document doc = Jsoup.connect("https://search.naver.com/search.naver?where=nexearch&sm=tab_etc&query=%EB%B0%95%EC%8A%A4%EC%98%A4%ED%94%BC%EC%8A%A4%20%ED%9D%A5%ED%96%89%EC%88%9C%EC%9C%84").get();
