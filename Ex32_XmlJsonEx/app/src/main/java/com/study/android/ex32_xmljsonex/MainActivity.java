    ...
    private void getJsonData2() {
        ...
        try {
            ...
            if(color.has("left")) {
                ...
                Log.d("lecture", "left color : " + top_color);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void getJsonData3() {
        ...
        try {
            ...
            for(int i=0;i<menuitemArray.length();i++) {
                Log.d("lecture", "value : " + menuitemArray.getJSONObject(i).getString("value"));
                Log.d("lecture", "value : " + menuitemArray.getJSONObject(i).getString("onclick"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
