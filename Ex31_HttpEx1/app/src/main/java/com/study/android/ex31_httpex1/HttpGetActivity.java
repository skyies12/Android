...
public class HttpGetActivity extends AppCompatActivity {
    ...
    public void onBtnGet(View v) {
        String sUrl = getString(R.string.server_addr) + "/JspServer/login.jsp";

        GetAcition myGetAct = new GetAcition();
    ...
    class GetAcition extends AsyncTask<String, Integer, String> {
