package com.study.android.htmlpasing;
...
//        Glide.with().load(mList.get(position).getImg_url())
//                .override(300,400)
//                .into(holder.imageView_img);

        //Glide.with(holder.itemView.getContext()).load("http://static.hubzum.zumst.com/hubzum/2018/02/06/09/962ec338ca3b4153b037168ec92756ac.jpg").into(holder.imageView_img);
    }
