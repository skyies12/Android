...
public class MainActivity extends BaseActivity implements onLocationChangedCallback
{
	...
	public static String mApiKey = "2f59a639-4a70-4e96-9322-de04c54c3ba2"; // 발급받은 SKT AppKey
						...
						public void granted() {
							...
							if (file.exists()) {
								...
								try {
									...
									out.flush();
									Toast.makeText(MainActivity.this, "Saved :" + fileCacheItem.getAbsolutePath(), Toast.LENGTH_LONG).show();
								} catch (Exception e) {
									Toast.makeText(MainActivity.this, "캡처 이미지 저장에 실패했습니다.", Toast.LENGTH_SHORT).show();
									e.printStackTrace();
								}
								finally {
									if(out != null) {
								...
								Toast.makeText(MainActivity.this, "캡쳐 디렉터리 생성에 실패했습니다.", Toast.LENGTH_SHORT).show();
							}
						}
